...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className={`flex items-center justify-between px-6 md:px-16 lg:px-24 py-4 text-gray-700 border-b border-borderColor relative transition-all duration-300
      ...
      <div className='hidden lg:flex items-center text-sm gap-2 
        border px-3 border-borderColor rounded-full max-w-56'>
        ...
        hover:bg-accent transition-all text-white rounded-lg">Login</button>
    </div>
      </div>

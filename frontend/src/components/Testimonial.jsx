...
const Testimonial = () => {
  return (
        ...
        <div className="text-center mb-8 mt-10">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">What Our Customers Say</h1>
            <p className="text-sm md:text-base text-gray-500 mt-4">Hear from our satisfied customers about their experience with our services</p>
        </div>
